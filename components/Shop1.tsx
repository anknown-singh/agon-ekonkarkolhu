...
const Shop1 = () => (
  ...
  <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;400&display=swap" rel="stylesheet"/>
    ...
    <div className="wrapper mx-auto text-gray-900 font-normal max-w-[1320px]">
          ...
          <div className="rounded-2xl border border-gray-200 py-8 text-center transition-all duration-200 group hover:border-bg-6 hover:translate-y-[-2px]">
            <a className="block" href="#">
              ...
              <img
                ...
                alt="computer icon"
              />
              <p className="text-heading-5 font-poppins font-bold mb-[5px]">
                Desktop PC
              </p>
      ...
      <div className="px-[12px] md:px-[36px] mt-[70px] xl:px-0 lg:mt-[98px]">
        <div className="mb-[35px] md:mb-[64px]">
          <h2 className="text-gray-900 font-bold font-poppins mb-5 text-[35px] leading-[44px] md:text-[46px] md:leading-[52px] lg:text-heading-1 md:mb-[30px] max-w-[725px]">
            Latest products
          </h2>
          <p className="text-quote md:text-lead-lg text-gray-600">
            Don’t miss world trending
          </p>
        </div>
        ...
        <div className="product-list mb-[64px]">
          <div className="grid-cols-1 !grid mt-[5px] gap-[30px] md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
      ...
      <div className="px-[12px] md:px-[36px] mt-[70px] xl:px-0 lg:mt-[140px]">
        <div className="mb-[40px] lg:mb-[73px]">
          <h2 className="text-gray-900 font-bold font-poppins mb-5 text-[35px] leading-[44px] md:text-[46px] md:leading-[52px] lg:text-heading-1 md:mb-[30px] max-w-[725px]">
            What's new
          </h2>
          <p className="text-quote md:text-lead-lg text-gray-600">
        ...
        <div className="grid grid-cols-1 gap-[30px] md:grid-cols-2 gap-y-[60px] lg:grid-cols-3">
          <div className="relative">
            <div className="relative">
              <div className="pr-[26px] aspect-[458/557]">
                <img
            ...
            <h3 className="font-bold font-poppins text-[20px] leading-[26px] md:text-heading-4 mt-[45px] md:mt-[73px] mb-[18px]">
              How To Blow Through Capital At An Incredible Rate
            </h3>
            <p className="text-text text-gray-500 mb-[15px]">
              Lorem ipsum dolor sit amet consectetur adipiscing elit interdum
              ullamcorper sed pharetra senectus donec nunc. Consequat semper
              viverra nam libero justo laoreet facilisis magna etiam.
            </p>
            <div className="flex items-center gap-[15px]">
              <img
                className="h-full w-full object-cover rounded-full max-w-[60px]"
                src="./assets/images/avatar-12.png"
                alt="avatar"
              />
              <div>
                <p className="text-lead line-clamp-2 font-bold mb-[3px] font-poppins lg:text-heading-6">
                  Jenny Wilson
                </p>
                <p className="text-md text-gray-500 font-bold text-sm">
                  August 25, 2022
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-8 md:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-6 pb-12 border-b border-gray-200 justify-between">
              <div className="flex-1">
                <p className="font-bold font-poppins text-[14px] md:text-heading-6 line-clamp-2 mb-[18px]">
                  Design Studios That Everyone Should Know
                </p>
                <div className="flex items-center gap-[11px]">
                  <img
                    className="h-full w-full object-cover rounded-full max-w-[42px]"
                    src="./assets/images/avatar-11.png"
                    alt="avatar"
                  />
                  <div>
              ...
              <div className="relative flex-1 max-w-[133px]">
                ...
                <div className="absolute w-full h-full left-0 z-0 top-0 translate-y-[13px] pl-[13px]">
                  <div className="w-full h-full rounded-2xl bg-opacity-50 transition-all duration-200 bg-bg-10 group-hover:-translate-x-[10px] group-hover:-translate-y-[10px]" />
                </div>
              </div>
            </div>
            <div className="flex items-center gap-6 pb-12 border-b border-gray-200 justify-between">
              ...
              <div className="relative flex-1 max-w-[133px]">
                ...
                <div className="absolute w-full h-full left-0 z-0 top-0 translate-y-[13px] pl-[13px]">
                  <div className="w-full h-full rounded-2xl bg-opacity-50 transition-all duration-200 bg-bg-3 group-hover:-translate-x-[10px] group-hover:-translate-y-[10px]" />
                </div>
              </div>
            </div>
            <div className="flex items-center gap-6 pb-12 border-b border-gray-200 justify-between">
              ...
              <div className="relative flex-1 max-w-[133px]">
                ...
                <div className="absolute w-full h-full left-0 z-0 top-0 translate-y-[13px] pl-[13px]">
                  <div className="w-full h-full rounded-2xl bg-opacity-50 transition-all duration-200 bg-bg-5 group-hover:-translate-x-[10px] group-hover:-translate-y-[10px]" />
                </div>
              </div>
            </div>
            <div className="flex items-center gap-6 pb-12 border-b border-gray-200 justify-between">
