...
const Strategies = () => (
    <div className="px-[12px] md:px-[36px] mt-[70px] xl:px-0 lg:mt-[100px]">
      <div className="text-center mb-[70px]">
        <h2 className="heading-style font-bold font-poppins mx-auto text-[35px] leading-[44px] md:text-[46px] md:leading-[52px] lg:text-heading-1 mb-5 md:mb-[30px] max-w-[725px]">
      ...
      <div className="lg:flex lg:gap-5 xl:gap-[30px]">
        <div className="rounded-2xl p-[30px] md:py-[53px] md:px-[48px] relative mb-5 flex flex-col justify-between transition-all duration-300 card-bg hover:translate-y-[-2px]">
          <div>
