    ...
    <div className="wrapper mx-auto text-gray-900 font-normal max-w-[1320px]">
      ...
      <div className="full-width relative">
        ...
        <div className="absolute text-center top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <span className="font-poppins inline-block bg-bg-6 text-green-900 py-[14px] px-[28px] rounded-[50px] text-[14px] leading-[14px] mb-[41px]">
            TECHNOLOGY NEWS
          </span>
          <h1 className="font-extrabold font-poppins text-[35px] leading-[44px] sm:text-[46px] sm:leading-[52px] md:text-heading-1 text-white w-[18ch] lg:w-[25ch] !font-semibold">
      ...
      <div className="px-[12px] md:px-[36px] mt-[70px] xl:px-0 mx-auto text-md text-gray-500 relative blog-content max-w-[830px] text-[14px] leading-[25px] md:text-[18px] md:leading-[32px]">
        ...
        <div className="flex items-center justify-between mb-7 md:mb-[57px]">
          ...
          <span className="font-poppins inline-block bg-bg-6 text-green-900 py-[14px] px-[28px] rounded-[50px] text-[14px] leading-[14px]">
            18 comments
          </span>
        </div>
        ...
        <h2 className="font-bold font-poppins text-[25px] leading-[30px] md:text-heading-3 mb-6 text-gray-900 md:mb-9">
          Use your headings
        </h2>
        <p className="mb-6 md:mb-9">
        ...
        <div className="bg-green-900 grid place-items-center px-5 rounded-[20px] pb-[45px] pt-[45px] md:pb-[77px] mb-[49px]">
          <div className="text-center max-w-[625px]">
            ...
            <img
              ...
              alt="quote icon"
            />
            <p className="text-white font-poppins mb-5 text-lead md:text-[32px] md:leading-[48px] md:mb-7">
            ...
            <div className="flex items-center justify-center scale-75 gap-[15px] md:scale-100">
              <img
                ...
                alt="avatar"
              />
              <p className="text-white font-bold font-poppins text-[22px] leading-[38px]">
                Ronald Richards
              </p>
            </div>
          </div>
        </div>
        <h3 className="font-bold font-poppins text-[20px] leading-[26px] md:text-heading-4 text-gray-900 mb-6 md:mb-9">
          Smaller heading
        </h3>
        ...
        <h2 className="font-bold font-poppins text-[25px] leading-[30px] md:text-heading-3 mb-10 text-gray-900">
          Use your headings
        </h2>
        ...
        <h2 className="font-bold font-poppins text-[28px] leading-[32px] md:text-heading-2 text-gray-900 mb-[35px] md:mb-[52px]">
          Comments
        </h2>
        ...
        <div className="w-full bg-gray-200 mb-7 h-[1px] md:mb-10" />
        <h3 className="font-bold font-poppins text-[20px] leading-[26px] md:text-heading-4 text-gray-900 mb-[30px] md:mb-[42px]">
          Leave a comment
        </h3>
        <form>
          <textarea
