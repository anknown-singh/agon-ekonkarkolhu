    ...
    <div className="wrapper mx-auto text-gray-900 font-normal max-w-[1320px]">
      ...
      <div className="full-width bg-bg-2">
        <div className="text-center px-5 pt-[74px] pb-[90px]">
          <h2 className="font-bold font-poppins text-[28px] leading-[32px] md:text-heading-2 mx-auto mb-[22px] md:w-[27ch]">
      ...
      <div className="px-[12px] md:px-[36px] mt-[70px] xl:px-0 mx-auto max-w-[1090px]">
        <div className="mx-auto max-w-[866px]">
          <h3 className="font-bold font-poppins text-[20px] leading-[26px] md:text-heading-4 mb-[17px]">
            Job Description
          </h3>
            ...
            <div className="flex items-center gap-[22px]">
              <button type="button">
                ...
                <a
                  ...
                  href="#"
                >
                  <span className="block text-inherit w-full h-full rounded-[50px] text-heading-6 font-poppins font-semibold">
                    Apply Now
                  </span>
                  <i>
                    {" "}
