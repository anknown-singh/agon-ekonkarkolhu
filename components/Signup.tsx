          ...
          >
            ...
            <div className="flex items-center mb-6 gap-[7px]">
              ...
              <span className="text-sm font-bold text-gray-500">
                Agree to{" "}
                <a className="text-green-900 hover:opacity-70" href="/">
                  terms & conditions
                </a>
              </span>
            </div>
            ...
            <div className="flex gap-2">
              ...
              <a className="text-green-900 hover:opacity-70" href="#">
                <p className="text-text">Sign in now</p>
              </a>
            </div>
          </form>
        </div>
      </div>
      <div className="full-width scale-75 translate-y-[-61%] mb-[-250px]">
        <div className="flex gap-[50px] ml-[-175px] lg:ml-[-315px]">
          {" "}
          <img
            className="rounded-2xl object-cover max-w-[332px] max-h-[403px]"
            src="./assets/images/thumbnail-12.png"
            alt="Agon"
          />
          <img
            className="rounded-2xl relative object-cover bottom-[-170px] max-w-[281px] max-h-[325px]"
            src="./assets/images/thumbnail-2.png"
            alt="Agon"
          />
          <img
            className="rounded-2xl relative object-cover w-[637px] h-[434px] bottom-[-50px]"
            src="./assets/images/thumbnail-5.png"
            alt="Agon"
          />
          <img
            className="rounded-2xl relative object-cover bottom-[-270px] max-w-[253px] max-h-[293px]"
            src="./assets/images/thumbnail-13.png"
            alt="Agon"
          />
          <img
            className="rounded-2xl object-cover relative max-w-[346px] max-h-[399px] bottom-[-90px]"
