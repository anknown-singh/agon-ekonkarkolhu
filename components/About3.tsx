...
const About3 = () => (
  ...
  <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;400&display=swap" rel="stylesheet"/>
    ...
    <div className="wrapper mx-auto text-gray-900 font-normal max-w-[1320px]">
      ...
      <div className="px-[12px] md:px-[36px] mt-[70px] xl:px-0 text-center">
        <div className="text-center mb-[35px] md:mb-[43px]">
        ...
        <h3 className="font-bold font-poppins text-[20px] leading-[26px] md:text-heading-4 text-gray-600 mx-auto mb-[40px] md:mb-[75px] md:w-[47ch]">
        ...
        <div className="relative mx-auto max-w-[1190px]">
          <img
            ...
            src="./assets/images/thumbnail-23.png"
            alt="Agon"
          />
      ...
      <div className="px-[12px] md:px-[36px] mt-[70px] xl:px-0 lg:mt-[138px]">
        <div className="text-center mb-[45px] lg:mb-[88px]">
      ...
      <div className="px-[12px] md:px-[36px] mt-[70px] xl:px-0 lg:mt-[150px]">
        <div className="lg:grid lg:grid-cols-2 gap-[150px]">
          <img
            className="h-full w-full object-cover order-first rounded-2xl mb-[30px] lg:mb-0 lg:flex-1"
      ...
      <div className="px-[12px] md:px-[36px] mt-[70px] xl:px-0 lg:mt-[88px]">
        <div className="grid grid-cols-2 flex-1 text-center gap-2 gap-y-8 md:grid-cols-2 xl:gap-y-[70px] lg:grid-cols-5 mb-[44px] md:mb-[88px]">
          <div>
      ...
      <div className="px-[12px] md:px-[36px] mt-[70px] xl:px-0 lg:mt-[128px]">
        <div className="text-center mb-[30px] md:mb-[90px]">
          <h2 className="font-bold font-poppins mx-auto text-[35px] leading-[44px] md:text-[46px] md:leading-[52px] lg:text-heading-1 text-gray-900 mb-5 md:mb-[30px] md:w-[13ch]">
            Building the Work Ecosystem
          </h2>
          <p className="text-quote md:text-lead-lg text-gray-600 mx-auto md:w-[56ch]">
            From year to year we strive to invent the most innovative technology
            that is used by both small and big enterprises
          </p>
        </div>
      ...
      <div className="px-[12px] md:px-[36px] mt-[70px] xl:px-0 lg:mt-[238px]">
