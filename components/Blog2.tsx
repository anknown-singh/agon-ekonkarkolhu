      ...
      <div className="px-[12px] md:px-[36px] mt-[70px] xl:px-0 lg:mt-[140px]">
        ...
        <div className="grid grid-cols-1 gap-[30px] md:grid-cols-2 gap-y-[60px] lg:grid-cols-3">
          <div className="relative">
            ...
            <h3 className="font-bold font-chivo text-[20px] leading-[26px] md:text-heading-4 mt-[45px] md:mt-[73px] mb-[18px]">
            ...
            <div className="flex items-center gap-[15px]">
              ...
              />
              <div>
                <p className="text-lead line-clamp-2 font-bold mb-[3px] font-chivo lg:text-heading-6">
                  Jenny Wilson
                </p>
