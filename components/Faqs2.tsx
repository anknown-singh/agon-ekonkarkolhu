  ...
  <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;400&display=swap" rel="stylesheet"/>
    ...
    <div className="wrapper mx-auto text-gray-900 font-normal max-w-[1320px]">
      ...
      <div className="full-width bg-bg-2">
        <div className="px-5 mx-auto flex flex-col pt-[48px] pb-[56px] max-w-[1320px] gap-[40px] lg:flex-row lg:items-center">
          <div>
            <h3 className="font-bold font-poppins text-[20px] leading-[26px] md:text-heading-4 mb-[23px]">
              Join the community with more than 12,368 topics already created
            </h3>
            <p className="text-text text-gray-400">
              Professional support team will solve your problem.
            </p>
          </div>
          <div>
            <div className="border bg-white border-opacity-10 shadow-4 flex items-start whitespace-nowrap flex-col gap-5 border-[#061224] py-[25px] px-[28px] rounded-[15px] md:flex-row md:items-center">
              <div className="flex w-full">
                <img src="./assets/images/icons/icon-search.svg" alt />
                <input
                  className="outline-none flex-1 placeholder:text-gray-400 placeholder:text-md placeholder:font-poppins py-0 px-[13px]"
                  type="text"
                  placeholder="Your question..."
                />
              </div>
              <div className="flex flex-col gap-5 md:flex-row">
                <div className="flex px-5 bg-gray-100 items-center py-[10px] rounded-[10px] gap-[15px]">
                  <p className="text-text">Pricing plan</p>
                  <div className="h-5 w-5">
                    <img
                      src="./assets/images/icons/icon-close-small.svg"
                      alt="close icon"
                    />
                  </div>
                </div>
                <button className="flex items-center transition-colors duration-200 py-[13px] px-[22px] rounded-[8px] text-heading-6 .font-bold bg-green-900 text-white w-fit">
                  Find now
                </button>
              </div>
            </div>
      ...
      <div className="px-[12px] md:px-[36px] mt-[70px] xl:px-0 mx-auto lg:mt-[139px] max-w-[1160px]">
      ...
      <div className="px-[12px] md:px-[36px] mt-[70px] xl:px-0 mx-auto lg:mt-[139px] max-w-[1248px]">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-[70px] gap-y-[30px]">
          <div className="flex items-start gap-3">
            ...
            />
            <div>
              <h4 className="font-bold font-poppins text-[14px] xl:text-heading-5 mb-[14px]">
